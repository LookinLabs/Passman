...
#     name_without_hyphens = lowercase_name.replace(HYPHEN, SPACE)
...
#     """
#     length = is_correct_length(new_password)

#     uppercase = includes_uppercase(new_password)

#     lowercase = includes_lowercase(new_password)

#     special = includes_special(new_password)

#     number = includes_number(new_password)

#     difference = is_different_from_old_password(old_password, new_password)

#     name_in_password = is_name_in_password(new_password, name)

#     birthday = is_birthday_in_password(new_password, birthdate)
