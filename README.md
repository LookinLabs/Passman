...
```
cd existing_repo
git remote add origin https://gitlab.com/Dan-I-El/pass_keeper.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Dan-I-El/pass_keeper/-/settings/integrations)
